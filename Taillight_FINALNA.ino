// Tailight with button Code
// Made by me: @LaughingStock
// Though this is a prototype, it should hopefully work as intended
// NOTE for the author: Mix two codes, one for the 8x8 LED matrix, one for the Ultrasonic sensor
// Use Boolean for the push button. (True or False)
